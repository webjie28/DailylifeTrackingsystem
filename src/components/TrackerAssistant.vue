...
<style scoped>
:global([data-theme="dark"]) .assistant-panel{background:#15221c;color:#f2f7f3;border-left-color:#385044;box-shadow:-24px 0 70px #0009}:global([data-theme="dark"]) .assistant-panel header button,:global([data-theme="dark"]) .assistant-disclosure,:global([data-theme="dark"]) .assistant-question,:global([data-theme="dark"]) .assistant-suggestions button{background:#22362c;color:#f2f7f3;border-color:#405b4b}:global([data-theme="dark"]) .assistant-panel input{background:#0e1813;color:#fff;border-color:#486454}:global([data-theme="dark"]) .assistant-panel input::placeholder{color:#9aaca1}:global([data-theme="dark"]) .assistant-reply{color:#f2f7f3}:global([data-theme="dark"]) .assistant-history-bar,:global([data-theme="dark"]) .assistant-panel header p,:global([data-theme="dark"]) .assistant-disclosure{color:#bdcbc2}:global([data-theme="navy"]) .assistant-panel{background:#122532;color:#f2f8fb;border-left-color:#355466;box-shadow:-24px 0 70px #02080db3}:global([data-theme="navy"]) .assistant-panel header button,:global([data-theme="navy"]) .assistant-disclosure,:global([data-theme="navy"]) .assistant-question,:global([data-theme="navy"]) .assistant-suggestions button{background:#1d3949;color:#f2f8fb;border-color:#406276}:global([data-theme="navy"]) .assistant-panel input{background:#0b1b25;color:#fff;border-color:#496b7d}:global([data-theme="navy"]) .assistant-reply{color:#f2f8fb}
