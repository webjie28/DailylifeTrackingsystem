...
.assistant-launch:hover{transform:translateY(-3px) scale(1.06);box-shadow:0 17px 38px #d9570061,0 0 0 9px #ef6c1b1f}.assistant-launch:focus-visible{outline:3px solid #ef6c1b55;outline-offset:5px}.assistant-launch svg{width:25px;height:25px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.assistant-launch-label{position:absolute;right:69px;min-width:128px;padding:9px 12px;border:1px solid var(--border-color);border-radius:12px;background:var(--bg-card);color:var(--text-primary);box-shadow:0 8px 24px #18231d20;text-align:left;white-space:nowrap}.assistant-launch-label strong,.assistant-launch-label small{display:block}.assistant-launch-label strong{font-size:13px}.assistant-launch-label small{margin-top:2px;color:var(--text-muted);font-size:11px;font-weight:500}.assistant-pulse{position:absolute;right:2px;top:2px;width:11px;height:11px;border:2px solid var(--bg-primary);border-radius:50%;background:#8fb46d}.assistant-pulse::after{content:'';position:absolute;inset:-4px;border:1px solid #8fb46d;border-radius:50%;animation:assistant-ping 2s ease-out infinite}@keyframes assistant-ping{0%{transform:scale(.7);opacity:.8}70%,100%{transform:scale(1.8);opacity:0}}@keyframes assistant-arrive{from{opacity:0;transform:translateY(18px) scale(.84)}to{opacity:1;transform:none}}
...
@media (prefers-reduced-motion:reduce){.assistant-launch{animation:none;transition:none}.assistant-pulse::after{animation:none}}
</style>
